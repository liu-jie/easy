package com.eirture.rxcommon.texts;
...
public class SpannableBuilder {
    ...
    public static SpannableBuilder createBuilder(@NonNull Context context) {
        return new SpannableBuilder(checkNotNull(context, "context == null"));
    }
    ...
    public static class Style implements Cloneable {
        ...
        /**
         * For more details see {@link com.eirture.rxcommon.texts.Fonts}
         */
